...
//PUBLIC API
//Вспомогательный код для проверки того что по данному урлу действительно находится изображение
//Если это так, то происходит обратный вызов callback функции при помощи замыкания
//Вторая функция - резервная копия изображения на случай если проверка не пройдена, создается локальный урл в файловой системе и выдача резервного изображения
class ImageFetcher {
